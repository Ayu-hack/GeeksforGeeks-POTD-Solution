  ...
  return (
    <Paper
      sx={{
        ...
        backgroundColor: "#F8EAE2", // Change background color to a lighter color
    ...
    >
      <HeaderSection
        ...
        bgColor={"#9B536F"} // Change background color
        personalInfo={personalinfo}
        workExperience={workexperience}
      />
      <Container>
        <TempHeading
          color={"#9B536F"} // Change color to the original color
          Hupcolor={"none"}
          Hupheight={"none"}
          Hdowncolor={"#9B536F"} // Change color to the original color
          Hdownheight={"none"}
